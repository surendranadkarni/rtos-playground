...
DEMO_SOURCE_DIR= ./FreeRTOS/DemoCommon/Minimal

# List C source files here. (C dependencies are automatically generated.)
# use file-extension c for "c-only"-files
SRC = $(TARGET).c 
SRC += serial/serial.c ParTest/ParTest.c 
#### FreeRTOS
SRC += $(DEMO_SOURCE_DIR)/integer.c \
...
#### FreeRTOS
EXTRAINCDIRS =  ./FreeRTOS/Source/include
EXTRAINCDIRS += ./FreeRTOS/DemoCommon/include
...
CFLAGS += $(CDEFS) $(CINCS)
CFLAGS += -O$(OPT)
CFLAGS += -Wall -Wextra -Wcast-align -Wimplicit 
